 ...
 */
@Extension
public class UserActionFactoryRssFailed extends TransientUserActionFactory {


    /**
     * Our logger.
     */
    private static final Logger LOG = Logger.getLogger(UserActionFactoryRssFailed.class.getName());
    ...
    public Collection<? extends Action> createFor(User user) {
        final UserActionRssFailed newAction = new UserActionRssFailed(user);

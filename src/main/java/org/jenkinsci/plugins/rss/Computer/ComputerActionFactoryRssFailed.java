 ...
 */
@Extension
public class ComputerActionFactoryRssFailed extends TransientComputerActionFactory {


    /**
     * Our logger.
     */
    private static final Logger LOG = Logger.getLogger(ComputerActionFactoryRssFailed.class.getName());
    ...
    public Collection<? extends Action> createFor(Computer computer) {
        final ComputerActionRssFailed newAction = new ComputerActionRssFailed(computer);

...
import org.jenkinsci.plugins.rss.AbstractProjectActionRssChangelog;
 ...
 */
@Extension
public class AbstractProjectActionFactoryRssChangeLog extends TransientActionFactory<AbstractProject> {
    /**
     * Our logger.
     */
    ...
    public Collection<? extends Action> createFor(AbstractProject abstractProject) {
        final AbstractProjectActionRssChangelog newAction = new AbstractProjectActionRssChangelog(abstractProject);

 ...
 */
@Extension
public class ViewActionFactoryRssAll extends TransientActionFactory<View> {
    /**
     * Our logger.
     */
    private static final Logger LOG = Logger.getLogger(ViewActionFactoryRssAll.class.getName());
    ...
    public Collection<? extends Action> createFor(View view) {
        final ViewActionRssAll newAction = new ViewActionRssAll(view);
